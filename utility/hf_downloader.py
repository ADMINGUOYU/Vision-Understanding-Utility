...
REPO_ID = "..."
TARGET_PATH = "..."
REPO_TYPE = "dataset"  # or "model" if downloading a model
...
def safe_download() -> None:
    max_retries = 10
    base_delay = 5
    
    print(f"Starting download for {REPO_ID} ({REPO_TYPE}) to {TARGET_PATH}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--repo_type", help = "Type of the repository to download (dataset or model)")
    # Parse
